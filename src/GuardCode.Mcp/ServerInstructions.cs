...
/// this string to the LLM as a system message, which is how GuardCode gets
...
internal static class ServerInstructions
{
    public const string Text =
        """
        GuardCode is a curated security and architecture guidance server for backend and systems code. When an archetype applies, treat its principles as authoritative.
        ...
        Skip this flow only for trivial edits (renames, formatting, obvious one-liners) or for work clearly outside GuardCode's scope (UI code, configuration files, documentation, tests for already-specified behavior). When in doubt, call 'prep' — it is cheap and deterministic, and returns an empty result when nothing applies.
        """;
}
